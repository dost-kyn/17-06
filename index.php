...
<head>
    ...
    <form action="auto/vendor/signup.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="panel-content">
                            ...
                            <p style="height: 50px; overflow: hidden;">
                                ...
                                if (isset($_SESSION['user']) )
                                {
                                    ...
                                    ?><a href="show.php" class="btn btn-info">Просмотр</a>
                            ...
                            <?php
                             if (empty($_SESSION['user'])) //Если БД не вернула результат
                                {?>
                            ...
                            <a href="../auto/vendor/logout.php" class="btn btn-success">Выход</a>
                                <?php }
                             ?>
                        </div>
                    </div>
